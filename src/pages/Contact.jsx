      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div>
            ...
            <h2 className="text-2xl font-black uppercase tracking-tight theme-text-primary mt-1">Get In Touch</h2>
            <p className="theme-text-secondary text-xs mt-3 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
            {/* Phone */}
            <div className="theme-card border rounded-xl p-5 flex items-start gap-4">
              <span className="bg-[#BF1E2E]/10 border border-[#BF1E2E]/20 text-[#BF1E2E] p-3.5 rounded-lg shrink-0"><FaPhoneAlt className="text-sm" /></span>
              <div>
                <h4 className="theme-text-primary font-extrabold text-xs uppercase tracking-wider">Phone Support</h4>
                <p className="theme-text-secondary text-xs mt-1">+233 576 021 655</p>
                <p className="theme-text-muted text-[10px] mt-0.5">Toll-free | Mon - Sat</p>
              </div>
            </div>
            ...
            <a
              ...
              className="theme-card border hover:border-green-600/40 rounded-xl p-5 flex items-start gap-4 transition-all"
            >
              <span className="bg-green-600/10 border border-green-500/20 text-green-500 p-3.5 rounded-lg shrink-0"><FaWhatsapp className="text-sm" /></span>
              <div>
                <h4 className="theme-text-primary font-extrabold text-xs uppercase tracking-wider">WhatsApp Advisor</h4>
                <p className="theme-text-secondary text-xs mt-1">+233 576 021 655</p>
            ...
            {/* Email */}
            <div className="theme-card border rounded-xl p-5 flex items-start gap-4">
              <span className="bg-blue-600/10 border border-blue-500/20 text-blue-500 p-3.5 rounded-lg shrink-0"><FaEnvelope className="text-sm" /></span>
              <div>
                <h4 className="theme-text-primary font-extrabold text-xs uppercase tracking-wider">Inquiries</h4>
                <p className="theme-text-secondary text-xs mt-1">promautosltd@gmail.com</p>
                <p className="theme-text-muted text-[10px] mt-0.5">Response within 24 hours</p>
              </div>
            </div>

            {/* Location */}
            <div className="theme-card border rounded-xl p-5 flex items-start gap-4">
              <span className="bg-purple-600/10 border border-purple-500/20 text-purple-500 p-3.5 rounded-lg shrink-0"><FaMapMarkerAlt className="text-sm" /></span>
              <div>
                <h4 className="theme-text-primary font-extrabold text-xs uppercase tracking-wider">Showroom Location</h4>
                <p className="theme-text-secondary text-xs mt-1">Achimota Mile 7</p>
                <p className="theme-text-muted text-[10px] mt-0.5">Accra, Ghana</p>
              </div>
            </div>

            {/* Hours */}
            <div className="theme-card border rounded-xl p-5 flex items-start gap-4">
              <span className="bg-amber-600/10 border border-amber-500/20 text-amber-500 p-3.5 rounded-lg shrink-0"><FaClock className="text-sm" /></span>
              <div>
                <h4 className="theme-text-primary font-extrabold text-xs uppercase tracking-wider">Working Hours</h4>
                <p className="theme-text-secondary text-xs mt-1">Mon - Sat: 8:00 AM - 6:00 PM</p>
                <p className="theme-text-muted text-[10px] mt-0.5">Sunday: Closed</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 theme-card border rounded-2xl p-6 md:p-8 shadow-xl">
          <h3 className="text-lg font-extrabold uppercase tracking-tight theme-text-primary mb-6">
          ...
          {submitted && (
            <div className="bg-green-950 border border-green-900 text-green-400 p-4 rounded-xl mb-6 flex items-center gap-3 animate-fade-in">
              <span className="bg-green-900 text-green-400 p-1.5 rounded-full shrink-0"><FaCheck className="text-xs" /></span>
              <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <select value={formData.interest} onChange={(e) => setFormData({ ...formData, interest: e.target.value })}
                ...
                <optgroup label="Vehicles">
                  {vehicles.map(v => <option key={v.id} value={v.name}>{v.name} ({v.condition})</option>)}
                </optgroup>
            ...
            <button type="submit" className="w-full bg-[#BF1E2E] hover:bg-red-800 text-white font-extrabold text-xs uppercase tracking-wider py-4 rounded-lg transition-all shadow-md cursor-pointer">
              Submit Inquiry
            </button>
          </form>
        </div>
