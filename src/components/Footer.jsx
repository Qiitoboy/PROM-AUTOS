...
const Footer = ({ setCurrentPage }) => {
  ...
  return (
    <footer className="theme-bg-primary border-t theme-border theme-text-secondary text-sm">
      {/* Top Banner section — stays red/dark by design */}
      ...
      <div className="max-w-7xl mx-auto py-12 px-6 md:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-3 pt-2">
            <a href="#" className="w-8 h-8 rounded-full theme-bg-secondary theme-border border flex items-center justify-center hover:bg-[#BF1E2E] hover:text-white transition-all theme-text-secondary">
              <FaFacebookF size={14} />
            </a>
            <a href="#" className="w-8 h-8 rounded-full theme-bg-secondary theme-border border flex items-center justify-center hover:bg-[#BF1E2E] hover:text-white transition-all theme-text-secondary">
              <FaTwitter size={14} />
        ...
        {/* Quick Links Column */}
        <div>
          <h4 className="theme-text-primary font-extrabold uppercase text-xs tracking-wider mb-4 border-l-2 border-[#BF1E2E] pl-3">
            Inventory &amp; Shop
          </h4>
          <ul className="space-y-2.5 text-xs">
            <li><a href="#" onClick={(e) => handleLinkClick("new-cars", e)} className="theme-text-secondary hover:text-[#BF1E2E] transition-colors">New Arrivals</a></li>
            <li><a href="#" onClick={(e) => handleLinkClick("used-cars", e)} className="theme-text-secondary hover:text-[#BF1E2E] transition-colors">Pre-Owned Supercars</a></li>
            <li><a href="#" onClick={(e) => handleLinkClick("parts", e)} className="theme-text-secondary hover:text-[#BF1E2E] transition-colors">Parts Vault Catalog</a></li>
            <li><a href="#" onClick={(e) => handleLinkClick("home", e)} className="theme-text-secondary hover:text-[#BF1E2E] transition-colors">Featured Gallery</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-xs">
            <li className="flex items-start gap-2.5">
              ...
              <span className="theme-text-muted leading-relaxed">
                Achimota Mile 7<br />
                Accra, Ghana
              </span>
            </li>
            <li className="flex items-center gap-2.5">
              ...
              <span className="theme-text-muted">+233 576 021 655</span>
            </li>
            <li className="flex items-center gap-2.5">
              <FaEnvelope className="text-[#BF1E2E] shrink-0" />
              <span className="theme-text-muted">promautosltd@gmail.com</span>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <form className="flex" onSubmit={(e) => e.preventDefault()}>
            <input
              ...
              className="theme-input border rounded-l px-3 py-2 text-xs focus:outline-none focus:border-[#BF1E2E] w-full"
            />
      ...
      {/* Bottom Legal bar */}
      <div className="theme-bg-secondary border-t theme-border py-6 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-3 text-xs theme-text-muted">
          <p>&copy; {new Date().getFullYear()} PROM AUTOS. All Rights Reserved. All vehicle specs are mock values.</p>
          <div className="flex space-x-4">
            <a href="#" className="hover:theme-text-secondary transition-colors">Privacy Policy</a>
            <a href="#" className="hover:theme-text-secondary transition-colors">Terms of Service</a>
