    ...
    <div className="group theme-card border rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col h-full">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="flex justify-between items-start gap-2 mb-4">
          <h3 className="font-extrabold text-base theme-text-primary group-hover:text-[#BF1E2E] transition-colors line-clamp-1">
            {name}
          </h3>
        ...
        {/* Specs Grid */}
        <div className="grid grid-cols-2 gap-3 text-xs theme-text-secondary mb-6 flex-grow">
          <div className="flex items-center gap-2 theme-bg-secondary p-2.5 rounded-lg border theme-border">
        ...
        <button
          ...
          className="w-full bg-transparent hover:bg-[#BF1E2E] theme-text-primary hover:text-white border border-[#BF1E2E] hover:border-transparent font-extrabold text-xs uppercase tracking-wider py-3 rounded-lg transition-all duration-200 cursor-pointer shadow-sm group-hover:shadow-md"
        >
          View Details
        </button>
      </div>
